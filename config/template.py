...
THEME_VARIABLES = {
    ...
    "template_name": "IBGADGETSTORE",
    "template_suffix": "Django Free Admin Template",
    "template_version": "2.0.0",
    "template_free": True,
    "template_description": "IBGADGETSTORE is a modern, clean and fully responsive admin template built with Bootstrap 5, Django 5, HTML, CSS, and JavaScript. It has a huge collection of reusable UI components. It can be used for all types of web applications like System Error pages, Authentication pages, admin dashboard.",
    ...
    "og_title": "IBGADGETSTORE Bootstrap 5 HTML + Django Admin Template by ThemeSelection",
